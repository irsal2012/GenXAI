...
const AgentBuilderPage = () => {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col">
      {/* Header */}
      <div className="bg-white border-b border-slate-200 px-6 py-4 dark:bg-slate-950 dark:border-slate-800">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Visual Agent Builder</h1>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-xl border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-900"
              title="Cancel and return to agents list"
            >
              Cancel
            </button>
            <button
        ...
        {/* Validation Error */}
        {validationError && (
          <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg dark:bg-red-950/50 dark:border-red-900">
        ...
        {createAgent.isSuccess && (
          <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg dark:bg-emerald-950/50 dark:border-emerald-900">
      ...
      {/* Help Banner */}
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-t border-slate-200 px-6 py-3 dark:from-slate-900 dark:to-slate-950 dark:border-slate-800">
