  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        {/* Modal */}
        <div className="relative w-full max-w-6xl bg-white rounded-xl shadow-2xl dark:bg-slate-950 dark:border dark:border-slate-800">
          {/* Header */}
          ...
          <div className="p-6">
            {validationError && (
              <div className="mb-4 rounded-lg bg-red-50 border border-red-200 p-4 flex items-start gap-3 dark:bg-red-950/60 dark:border-red-900">
                <ExclamationTriangleIcon className="h-5 w-5 text-red-500 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-sm font-semibold text-red-800 dark:text-red-200">Validation Error</h4>
